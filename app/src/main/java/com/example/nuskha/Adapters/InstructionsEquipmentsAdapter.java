package com.example.nuskha.Adapters;
...
import com.example.nuskha.Models.Equipment;
import com.example.nuskha.Models.Ingredient;
import com.example.nuskha.R;
...
public class InstructionsEquipmentsAdapter extends  RecyclerView.Adapter<InstructionsEquipmentsViewHolder>{
    ...
    public InstructionsEquipmentsViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new InstructionsEquipmentsViewHolder(LayoutInflater.from(context).inflate(R.layout.list_instructions_step_item, parent, false));
    }
